...
namespace AcroniUI.LoginAndSignUp
{
    public partial class FrmCadastro : Form
    {
        ...
        bool visibilidade_1, visibilidae_2 = false;
        private void pnlVisibiladade1_Click(object sender, EventArgs e)
        {
            ...
            {
                pnlVisibilidade1.BackgroundImage = AcroniUI.Properties.Resources.olhoblock;
                txtSenha.isPassword = true;
        ...
        private void pnlVisibilidade2_Click(object sender, EventArgs e)
        {
            if (!visibilidae_2)
            {
                pnlVisibilidade2.BackgroundImage = AcroniUI.Properties.Resources.olhoblock;
